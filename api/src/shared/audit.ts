...
const ENTIDADES: Record<string, { etiqueta: string; campos: string[] }> = {
  ...
  programas_mantenimiento:         { etiqueta: 'Programa de mantenimiento', campos: ['nombre', 'marca', 'modelo'] },
  programa_operaciones:            { etiqueta: 'Operación del programa', campos: ['nombre', 'programa', 'marca', 'modelo'] },
  vehiculo_programa:               { etiqueta: 'Programa de la unidad', campos: ['etapa', 'programa_id', 'km_inicio', 'fecha_inicio'] },
  vehiculo_programa_visita:        { etiqueta: 'Visita del programa',   campos: ['etapa', 'fecha', 'km'] },
  vehiculo_operacion_estado:       { etiqueta: 'Operación atendida',    campos: ['operacion_id', 'fecha', 'km'] },
