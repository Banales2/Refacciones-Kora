...
const ENTIDADES: Record<string, { etiqueta: string; campos: string[] }> = {
  ...
  vehiculo_programa:               { etiqueta: 'Programa de la unidad', campos: ['programa_id', 'km_inicio', 'fecha_inicio'] },
  vehiculo_programa_visita:        { etiqueta: 'Visita del programa',   campos: ['fecha', 'km'] },
